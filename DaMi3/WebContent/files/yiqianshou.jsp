...
function showlist(n)
{
	 ...
	 $.ajax({
		     ...
		     success:function(data){
                ...
                +"<td width='8%' height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'><span class='STYLE10'><a onclick='s("+this.id+")'>关闭</a>"
                +"</span></div></td></tr>");
                if(this.info == 0){
                  	 $("#tds").html("未发货");
                   }
	 ...
	 $("#page tr").remove();
	 $.ajax({
	     url:"select_showPages?indent.info=3",
	     type:"post",
	     data:{"page.pagenow":n},
	     success:function(data){
...
$(function(){
	$("#select").click(function(){
		...
		$.ajax({
			url:"cha_findss",
			type:"POST",
			data:{"indent.info":3,"indent.totalprices":$("#select1").val()},
			success:function(data){
				$("#page tr").remove();
				$("#yan~tr").remove();
		    	 $.each(data,function(){
